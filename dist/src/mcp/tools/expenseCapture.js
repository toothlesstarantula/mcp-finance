...
import { newDraftId, saveDraft } from './expenseDraftStore.js';
const PaymentMethodSchema = z.enum(['CASH', 'CARD_NU', 'CARD_BBVA', 'CARD_HSBC_VIVA']);
export function registerExpenseCaptureTool(server, userId) {
    server.registerTool('expense.capture', {
        title: 'Capturar gasto (borrador)',
        description: 'Crea un borrador de gasto y devuelve preguntas faltantes para poder confirmarlo.',
        ...
        const draft = {
            ...
            amountCents: typeof args.amount === 'number'
